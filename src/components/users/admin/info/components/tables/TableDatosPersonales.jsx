            ...
            {personalInfoUser !== null ?
                <div ref={tablesRef} className='p-10'>
                    ...
                    <table className='w-full my-4'>
                        <thead className='!border-none'>
                            <tr className='!border-none'>
                                <th colSpan="5" className="!border-none bg-cyan-700 text-white" style={{ backgroundColor: '#1D2243', fontSize: '16px' }}>DATOS DEL CLIENTE</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table className='w-full my-4'>
                        <thead className='!border-none'>
                            <tr className='!border-none'>
                                <th colSpan="5" className="!border-none bg-cyan-700 text-white" style={{ backgroundColor: '#1D2243', fontSize: '16px' }}>
                                    INFORME TECNICO
                                </th>
                            </tr>
                            <tr className='!border-none'>
                                <th colSpan="5" className="!border-none bg-purple-600 text-white" style={{ backgroundColor: '#5A69AF', fontSize: '16px' }}>
